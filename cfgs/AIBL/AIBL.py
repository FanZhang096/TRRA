...
def init(mdlParams_):
    ...
    mdlParams['caps_directory'] = '/work/image/AIBL_dataset/caps/'
    ...
    mdlParams['output_dir_base'] = '/home/zf/AD_codes/Alzheimer_disease_codes_0701/results/'
    # save the temporary files
    mdlParams['temporary_val'] = '/home/zf/AD_codes/Alzheimer_disease_codes_0701/results/temporary_val/'
    # Model name
    mdlParams['model_type'] = 'efficientnet_b1'
    # mdlParams['dropout_rate'] = 0.5
    # mdlParams['drop_connect_rate'] = 0.2

    # Transforms name  'wen_paper' 'plain' 'rand-augment' 'rand-augment-20' 'rand-augment-23'
    # 'random-rand-augment' 'two-stage-random-rand-augment'
    mdlParams['transforms_name'] = 'two-stage-random-rand-augment'

    # for rand-augment(20, 23) and random-rand-augment
    mdlParams['N'] = 7
    mdlParams['M'] = 5
    ...
    # mdlParams['AD_CN_model_path'] = '/home/zxt/4T/Alzheimer_disease_codes/models/efficientnet_b1/checkpoint_1.pth.tar'
    return mdlParams
